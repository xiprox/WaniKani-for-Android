 ...
 */
public class CriticalItemsPercentagePreference extends DialogPreference {

    NumberPicker mNumberPicker;

    private int DEFAULT_VALUE = 75;

    private int mCurrentValue = 75;

    public CriticalItemsPercentagePreference(Context context, AttributeSet attrs) {
        super(context, attrs);
