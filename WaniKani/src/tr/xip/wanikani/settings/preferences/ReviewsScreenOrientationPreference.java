 ...
 */
public class ReviewsScreenOrientationPreference extends DialogFragment implements RadioButton.OnClickListener {
    ...
    ReviewsScreenOrientationPreferenceListener mListener;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                prefMan.setReviewsScreenOrientation(mSelection);
                mListener.onReviewsScreenOrientationPreferenceChanged(mSelection);
                dismiss();
            }
        });
    ...
    private void loadPreference() {
        String preference = prefMan.getReviewsScreenOrientation();
    ...
    public interface ReviewsScreenOrientationPreferenceListener {
